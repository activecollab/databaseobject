...
class Type extends Base
{
  ...
  public function setConditions($conditions)
  {
    if ($conditions) {
      if (is_string($conditions)) {
        $this->conditions = DB::prepareConditions(func_get_args()); return;
      } elseif (is_array($conditions)) {
        $this->conditions = DB::prepareConditions($conditions); return;
      }
    }
  ...
  public function setJoinTable($table_name_without_prefix, $join_field = null)
  {
    ...
    if (empty($this->join_with_field)) {
      ...
      } else {if (is_string($join_field) && $join_field) {
